 ...
 *
 * - summarizeArticle - A function that generates concise article summaries.
...
const SummarizeArticleOutputSchema = z.object({
  summary: z
    .string()
    .describe('A concise summary of the article, suitable for preview display.'),
});
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following article content into a concise summary suitable for use as a preview. Keep it short and engaging.\n\nArticle Content:\n{{{articleContent}}}`,
});
